        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EMPRSID = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "RestaurateursRequests",
                columns: table => new
                {
                    RestaurateurId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurateursRequests", x => x.RestaurateurId);
                    table.ForeignKey(
                        name: "FK_RestaurateursRequests_AspNetUsers_RestaurateurId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RestaurateurId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GoogleMaps = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AvgRating = table.Column<double>(type: "float", nullable: false),
                    RegionalCity = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoritesRestaurants", x => new { x.RestaurantId, x.UserId });
                    table.ForeignKey(
